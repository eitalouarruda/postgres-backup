## This repository is a fork from https://github.com/schickling/dockerfiles/tree/master/postgres-backup-s3
## For some reason I can't deploy it on easypanel without do the fork
## But I don't want all the dockerfiles from schickling, just the postgres-backup-s3 and the restore at some point
